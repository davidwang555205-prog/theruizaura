...
const bagClausePatterns = [
  ...
  /\s+with\s+a\s+(?:taupe|cream|canvas|woven|black|small|structured|practical|light tan|grey|pale grey|muted brown|soft beige|beige|travel|gym|secondary|daily|refined|leather|shoulder|crossbody|handheld|hand-held|tote|handbag|bag|travel bag|gym bag|shopping bag|paper bag|bakery paper bag)(?:\s+(?:taupe|cream|canvas|woven|black|small|structured|practical|light tan|grey|pale grey|muted brown|soft beige|beige|travel|gym|secondary|daily|refined|leather|shoulder|crossbody|handheld|hand-held|tote|handbag|bag|travel bag|gym bag|shopping bag|paper bag|bakery paper bag)){0,5}/gi,
