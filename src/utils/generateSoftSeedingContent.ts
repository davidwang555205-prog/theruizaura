...
const topicImageDrafts: Record<SoftSeedingTopic, SoftSeedingImageDraft[]> = {
  ...
  棚内上新拍摄: [
    ...
    { id: "studio-launch-full-three-quarter", name: "图2｜棚拍人物｜全身前侧", purpose: "以两步入场补充全身三分之四角度，保留完整人物与穿搭。", description: "同一人物斜侧两步入场后停稳，双鞋仍清楚。", imageType: "产品上脚图", scenePreference: "棚内上新拍摄", garmentTypePreference: "自动匹配", studioLaunchShotIndex: 1, extraRequirement: "Continue the exact same person, outfit, sneakers, and studio. Use a shallow side-diagonal two-step entry across the camera plane and settle into the assigned full-body 3/4 front position. Keep both hands empty, use natural arm swing, and avoid campaign drama or movement toward the lens." },
    { id: "studio-launch-full-side", name: "图3｜棚拍人物｜全身侧面", purpose: "以横向步态展示人物比例、鞋侧结构与鞋底线。", description: "同一人物完成两至三步侧面横向走动，鞋侧结构可读。", imageType: "产品上脚图", scenePreference: "棚内上新拍摄", garmentTypePreference: "自动匹配", studioLaunchShotIndex: 2, extraRequirement: "Continue the exact same person, outfit, sneakers, and studio in one two-to-three-step lateral walk through the full-body side profile. Keep natural posture and arm swing, accurate foot placement, and a subtly engaged face; stop on the assigned mark without approaching the lens." },
    { id: "studio-launch-full-turn-back", name: "图4｜棚拍人物｜走动回身", purpose: "用两步走动后的回身增加变化，不改变人物和穿搭。", description: "同一人物横向走两步后完成后侧三分之四回身，至少一只鞋完整清楚。", imageType: "产品上脚图", scenePreference: "棚内上新拍摄", garmentTypePreference: "自动匹配", studioLaunchShotIndex: 3, extraRequirement: "Continue the exact same person, outfit, sneakers, and studio. Complete exactly two controlled lateral studio steps and flow into one rear 3/4 turn on the final mark. Keep both hands empty, facial response natural if visible, and at least one complete sneaker unobstructed." },
    { id: "studio-launch-lower-front", name: "图5｜棚拍人物｜下半身落脚", purpose: "通过一次完整落脚检查衣摆、腿部和鞋子的正面比例。", description: "同一人物在腰部或大腿以上至地面构图内完成一次完整步态，双鞋正面可读。", imageType: "产品上脚图", scenePreference: "棚内上新拍摄", garmentTypePreference: "自动匹配", studioLaunchShotIndex: 4, extraRequirement: "Continue the exact same outfit and person reference in the assigned waist-or-upper-thigh-to-floor front crop. Complete one controlled step across a shallow path parallel to the camera plane, with heel contact, natural weight transfer, forefoot roll, and a stable final stance. Keep hands outside the frame and preserve garment hem, toe box, laces, outsole, and ground contact." },
    ...
    { id: "studio-launch-on-foot-three-quarter", name: "图8｜棚拍人物｜上脚前侧落步", purpose: "以一次可控落步补充鞋头曲线、侧片与鞋底线的前侧信息。", description: "同一人物中小腿以下完成一次侧向落步，鞋型和接地自然。", imageType: "产品上脚图", scenePreference: "棚内上新拍摄", garmentTypePreference: "自动匹配", studioLaunchShotIndex: 7, extraRequirement: "Continue the exact same person, outfit, sneakers, and studio in the assigned on-foot 3/4 front-side detail. Complete one controlled lateral step into the final mark, show heel contact and stable outsole settlement, then hold toe curve, side panels, lace area, and ground contact without cropping, distortion, hands, or props." }
  ]
};
...
const studioSeriesActionTrack: SeriesActionBeat[] = [
  ...
  { key: "studio-diagonal-entry", poseType: "walking", directive: "Studio action variation: shallow side-diagonal two-step entry across the camera plane, ending in a full-body three-quarter stance with natural arm swing." },
  { key: "studio-lateral-walk", poseType: "walking", directive: "Studio action variation: one continuous two-to-three-step lateral side-profile walk with readable heel contact, weight transfer, and push-off." },
  { key: "studio-walk-turn", poseType: "walking", directive: "Studio action variation: exactly two lateral steps flowing into one rear three-quarter turn and a stable final heel-settle." },
  { key: "studio-lower-step", poseType: "walking", directive: "Studio action variation: one complete controlled step inside the waist-to-floor crop, preserving heel contact, forefoot roll, and final ground contact." },
  ...
  { key: "studio-on-foot-step-finish", poseType: "walking", directive: "Studio action variation: one controlled lateral step inside the tight on-foot frame, ending with visible heel contact, outsole settlement, and no repeated static foot placement." }
];
