...
const topicImageDrafts: Record<SoftSeedingTopic, SoftSeedingImageDraft[]> = {
  ...
  接娃: [
    ...
    { name: "图5｜收尾｜回家进门", purpose: "让一天结束，强调鞋子没有成为负担。", description: "放下托特包和外套，一天结束的松弛感。", imageType: "生活场景图", scenePreference: "回家进门", garmentTypePreference: "裤装", extraRequirement: "Use a home entryway moment after pickup, tote bag and coat placed down, relaxed end-of-day body language, shoes clear and still naturally worn." }
  ],
  周末: [
    { name: "图1｜封面｜玄关出门", purpose: "周末第一张要轻松，但还是有质感。", description: "周末玄关出门，浅色针织或白衬衫配直筒裤，搭配帆布托特。", imageType: "对镜穿搭图", scenePreference: "玄关出门", garmentTypePreference: "裤装", extraRequirement: "Use a relaxed weekend entryway mirror outfit, ivory knit or white shirt, warm beige straight trousers, canvas tote, face partly hidden by phone, calm not influencer-like." },
  ...
  女性日常: [
    ...
    { name: "图5｜静物｜材质工作台", purpose: "最后补品牌质感，不让整组全是人物。", description: "鞋子、白衬衫、色卡和皮料，表达日常秩序。", imageType: "产品静物图", scenePreference: "材质工作台", garmentTypePreference: "自动匹配", extraRequirement: "Create a refined product still life with the selected sneakers, white shirt fabric, subtle color cards, leather swatches, warm stone surface, quiet daily order." }
  ]
};
