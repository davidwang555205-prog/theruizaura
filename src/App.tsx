...
import { ImmersiveNarrativeWorkspace } from "./immersive-narrative";
import { CommercialFilmWorkspace } from "./commercial-film";
import {
...
function App() {
  const [activePage, setActivePage] = useState<"workbench" | "prompt" | "xiaohongshu" | "visual" | "atmosphere" | "fmcg" | "narrative" | "commercial">("workbench");
