...
> = {
  ...
  酒店房间:
    "Create one believable hotel-room detail with a chair edge, neatly opened suitcase, folded clothing, curtain light, and one travel object. Keep any bed, bedding, and sleeping area out of frame. Avoid bathroom counters, luggage clutter, and brochure styling.",
  "酒店门口 / 门厅":
...
export const NON_PRODUCT_ATMOSPHERE_SCENE_REGISTRY: Record<AtmosphereSceneId, AtmosphereSceneArchetype> = {
  ...
  HOTEL_TRAVEL: { id: "HOTEL_TRAVEL", locationLock: "a temporary hotel transition or room corner during a short trip", requiredSpatialCues: ["hotel curtain or temporary-room daylight", "suitcase corner or travel tote", "folded itinerary or room card", "restrained temporary-living trace"], forbiddenSpatialCues: ["luxury hotel advertisement", "bed", "bed edge", "bedding", "sleeping area", "centered hotel bed", "bedding hero image", "resort styling", "product display"], allowedObjects: ["travel tote", "suitcase corner", "itinerary", "room card", "chair edge"], cameraDirection: "layered transition-space composition led by changing daylight", lifeTraceDirection: "the room appears briefly occupied during a short trip without showing the sleeping area", indoorOutdoor: "indoor", dominantPlane: "window", cameraHeight: "eye_level", depthPattern: "layered", dominantObject: "folded itinerary" },
