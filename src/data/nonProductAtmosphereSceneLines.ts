...
> = {
  ...
  海边度假:
    "Create a South of France or southern Italy Mediterranean seaside atmosphere using a pale limestone promenade, warm off-white coastal lane, restrained residential-terrace threshold, or quiet sea-facing corner. Add only one subtle cue such as linen texture, sunglasses, a book, or a woven bag. Keep the location lived-in and regionally believable rather than tropical, postcard-like, or generic.",
  草原野餐:
  ...
  周末轻旅行出发:
    "Create one weekend-departure atmosphere at a residential building threshold, tidy travel-bag corner, car-side loading detail, or travel-start table with a tote, light jacket, sunglasses, or paper bag. Keep it light, anticipatory, and grounded in ordinary city life."
};
...
export const NON_PRODUCT_ATMOSPHERE_SCENE_REGISTRY: Record<AtmosphereSceneId, AtmosphereSceneArchetype> = {
  ...
  RETURN_HOME_TABLE: { id: "RETURN_HOME_TABLE", locationLock: "a real apartment entry table or console near a hallway", requiredSpatialCues: ["table or console near an apartment entrance", "tote or grocery paper bag recently set down", "one used ceramic cup", "receipt, folded note, flower paper or light cardigan", "visible depth toward an entrance or hallway"], forbiddenSpatialCues: ["bedroom", "styled product table", "flatlay", "showroom", "café table", "staged luggage display"], allowedObjects: ["tote", "grocery paper bag", "ceramic cup", "receipt", "flower paper"], cameraDirection: "slightly high observational crop with layered foreground depth", lifeTraceDirection: "objects show the quiet aftermath of returning home", indoorOutdoor: "threshold", dominantPlane: "table", cameraHeight: "slightly_high", depthPattern: "foreground_obstruction", dominantObject: "used ceramic cup" },
