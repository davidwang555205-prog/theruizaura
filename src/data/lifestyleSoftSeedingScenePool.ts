...
export const lifestyleSoftSeedingScenePool: LifestyleSoftSceneEntry[] = [
  ...
  },
  {
    ...
    description: "住宅门厅或普通建筑门口出发前停留，旅行包只作背景。",
    imageType: "生活场景图",
    scenePreference: "周末轻旅行出发",
    garmentTypePreference: "裤装",
    extraRequirement: "Use a quiet weekend-trip departure near a residential lobby or ordinary building threshold, with any travel bag placed nearby rather than held, hands relaxed and natural, and clear sneakers.",
    family: "travel",
    supportedSeasons: ALL_SEASONS,
    handheldPolicy: "none",
    weight: 4
