...
export const lifestyleSoftSeedingScenePool: LifestyleSoftSceneEntry[] = [
  ...
  },
  {
    ...
    garmentTypePreference: "裤装",
    extraRequirement: "Use a calm hotel travel moment before leaving, with luggage kept as a small background cue, hands relaxed and natural, warm neutral light, and clearly readable sneakers.",
    family: "travel",
    supportedSeasons: ALL_SEASONS,
    handheldPolicy: "none",
    weight: 4
  ...
  },
  {
    ...
    garmentTypePreference: "裤装",
    extraRequirement: "Use a restrained hotel entrance or lobby-threshold pause with any luggage kept nearby rather than held, hands relaxed and natural, and no influencer check-in mood.",
    family: "travel",
    supportedSeasons: ALL_SEASONS,
    handheldPolicy: "none",
    weight: 3
  },
  {
    ...
    garmentTypePreference: "裤装",
    extraRequirement: "Use a quiet weekend-trip departure near a building or hotel threshold, with any travel bag placed nearby rather than held, hands relaxed and natural, and clear sneakers.",
    family: "travel",
    supportedSeasons: ALL_SEASONS,
    handheldPolicy: "none",
    weight: 4
