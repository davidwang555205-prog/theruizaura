...
export const MATURE_SCENE_BLOCKS: SceneBlock[] = [
  {
    ...
    category: "mature",
    compactPrompt: "A refined school-related daily scene near a calm school entrance, corridor, campus walkway, or waiting area. She looks composed, approachable, and tasteful, not overly formal. The sneakers should feel comfortable, polished, and appropriate for family responsibility with personal style.",
  ...
  },
  {
    ...
    category: "mature",
    compactPrompt: "A refined car-side mobility scene: standing beside a car door, taking a tote from the back seat, or walking from parking to elevator. The car remains subtle daily context, not a status symbol. The sneakers should look comfortable, polished, and stable in movement.",
  ...
  },
  {
    ...
    category: "mature",
    compactPrompt: "A quiet self-care scene in a warm neutral salon, skincare studio, hair salon, nail salon, or spa reception. She looks relaxed, natural, and refined, not glamorous. The sneakers belong to a comfortable but tasteful everyday outfit.",
  ...
  },
  {
    ...
    category: "mature",
    compactPrompt: "A calm weekend city walk in a quiet street, riverside path, gallery district, cafe exterior, bookstore street, or light stone wall setting. The mood should be relaxed, tasteful, mature, and confident, not touristy or influencer-like.",
