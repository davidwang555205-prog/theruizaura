...
const cityContexts: SeasonCityContext[] = [
  {
    ...
    photoMoodLine: "A clean Shanghai spring mood with airy street depth, muted neighborhood storefronts, gentle greenery, and natural skin tone.",
  ...
  },
  {
    ...
    cityProfile: "Chengdu",
    defaultTimeOfDay: "late afternoon",
    lightLine: "Soft warm autumn street light with relaxed neighborhood atmosphere, textured knit, and muted denim depth.",
  ...
  },
  {
    ...
    lightLine: "Gentle spring daylight with soft grey stone, calm storefront light, and restrained greenery.",
  ...
  },
  {
    ...
    lightLine: "Gentle warm-grey autumn light with quiet storefront texture, muted knit and skirt material, and soft street shadows.",
