...
export const activePromptTemplates: Record<ActivePromptTemplateName, string> = {
  ...
  gymCommute_mirror:
    "Create a premium THERUIZ AURA mirror outfit image before or on the way to a light workout. The face should be hidden by the phone or naturally cropped, while the outfit and sneakers remain clear. The styling should bridge daily city wear and light activity, with a clean practical tote or understated gym bag. Avoid influencer fitness posing, dark gym mirrors, technical sportswear, or figure-emphasizing selfie energy."
};
